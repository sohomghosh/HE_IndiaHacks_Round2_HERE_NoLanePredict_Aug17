...
params = {"objective": "multi:softmax","booster": "gbtree", "nthread": 4, "silent": 1,"eta": 0.09, "max_depth": 10, "subsample": 0.9, "colsample_bytree": 0.7,"min_child_weight": 1, "num_class": 6,"seed": 2016, "tree_method": "exact","gamma":0.2,'reg_alpha':1e-5,"n_estimators":5000}
...
ans1.to_csv("sub37.csv", index=False)
