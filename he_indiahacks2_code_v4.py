...
features=['totalLaneLines','totalLinesOnLeft','totalLaneLinesOnRight','distFromLaneLineOnLeft','distFromLaneLineOnRight','laneLineLength','roadLength','noOfIntersectingLaneLinesLeft','noOfIntersectingLaneLinesRight','num_roadCategory','tr_rd_cat','fl_rd_cat','num_laneLineCoordinates']
...
ans1.to_csv("sub4.csv", index=False)
