...
train_set['new_totalLaneLines']=train_set['totalLaneLines'] -1
test['new_totalLaneLines']=test['totalLaneLines'] -1

features=['totalLaneLines','totalLinesOnLeft','totalLaneLinesOnRight','distFromLaneLineOnLeft','distFromLaneLineOnRight','laneLineLength','roadLength','noOfIntersectingLaneLinesLeft','noOfIntersectingLaneLinesRight','num_roadCategory','tr_rd_cat','fl_rd_cat','new_totalLaneLines']
...
ans1.to_csv("sub3.csv", index=False)
